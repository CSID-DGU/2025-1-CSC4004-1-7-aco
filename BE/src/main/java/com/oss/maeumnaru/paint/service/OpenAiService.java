...
public class OpenAiService {
    ...
    public String generateFollowUpQuestion(String patientReply) {
        ...
        JSONObject message1 = new JSONObject()
                .put("role", "system")
                .put("content", "당신은 감정 분석 상담사입니다. 채팅창 옆에는 사용자가 그린 그림이 띄워져있고 당신은 이 그림에 관해 사용자와 대화할 것입니다. 사용자의 응답에 따라 초반에는 그림의 의미를 탐색하는 질문을, 이후로는 사용자의 감정에 공감하고 위로하며 우울증 환자에게 도움이 될 수 있도록 질문하며 대화를 이끌어주세요. 너무 길게 설명하지 말고 두세 문장으로만 대답해주세요.");
